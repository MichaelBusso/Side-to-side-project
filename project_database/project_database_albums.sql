...
CREATE TABLE `albums` (
  ...
  KEY `albums_id_fk_idx` (`userId`),
  CONSTRAINT `albums_id_fk` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2023-12-27 23:53:03
